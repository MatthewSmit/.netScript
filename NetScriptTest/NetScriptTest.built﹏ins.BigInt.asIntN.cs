...
namespace NetScriptTest.built﹏ins.BigInt
{
    public sealed class Test_asIntN : BaseTest
    {
        ...
        [Fact(DisplayName = "/built-ins/BigInt/asIntN/bigint-tobigint-errors.js")]
        public void Test_bigint﹏tobigint﹏errors_js()
        {
            RunTest("built-ins/BigInt/asIntN/bigint-tobigint-errors.js");
        }

        [Fact(DisplayName = "/built-ins/BigInt/asIntN/bigint-tobigint-toprimitive.js")]
        public void Test_bigint﹏tobigint﹏toprimitive_js()
        {
            RunTest("built-ins/BigInt/asIntN/bigint-tobigint-toprimitive.js");
        }

        [Fact(DisplayName = "/built-ins/BigInt/asIntN/bigint-tobigint-wrapped-values.js")]
        public void Test_bigint﹏tobigint﹏wrapped﹏values_js()
        {
            RunTest("built-ins/BigInt/asIntN/bigint-tobigint-wrapped-values.js");
        }
        ...
        [Fact(DisplayName = "/built-ins/BigInt/asIntN/bits-toindex-errors.js")]
        public void Test_bits﹏toindex﹏errors_js()
        {
            RunTest("built-ins/BigInt/asIntN/bits-toindex-errors.js");
        }

        [Fact(DisplayName = "/built-ins/BigInt/asIntN/bits-toindex-toprimitive.js")]
        public void Test_bits﹏toindex﹏toprimitive_js()
        {
            RunTest("built-ins/BigInt/asIntN/bits-toindex-toprimitive.js");
        }

        [Fact(DisplayName = "/built-ins/BigInt/asIntN/bits-toindex-wrapped-values.js")]
        public void Test_bits﹏toindex﹏wrapped﹏values_js()
        {
            RunTest("built-ins/BigInt/asIntN/bits-toindex-wrapped-values.js");
        }
